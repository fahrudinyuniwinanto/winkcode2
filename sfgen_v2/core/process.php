...
if (isset($_POST['generate']))
{
    ...
    if ($table_name <> '')
    {
        ...
        if (!file_exists($target . "views/backend/" . $c_url))
        {
            mkdir($target . "views/backend/" . $c_url, 0777, true);
        }
        ...
        if ($jenis_tabel == 'reguler_table') {
            ...
            include 'core/create_view_lookup.php';
        } else {
