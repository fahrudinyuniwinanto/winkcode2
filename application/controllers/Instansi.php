...
class Instansi extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->m = new Instansi_model();
    }

    public function index()
    {
        $data = array(
            'content' => "backend/instansi/instansi_frm",
        );
    ...
    public function lookup()
    {
        ...
        $total = $this->db->from($this->m->table)
            ->like('nama_instansi', $q)
            ->count_all_results();
        $current = $this->db->select('kode_instansi, nama_instansi, alamat, no_telp')
            ->from($this->m->table)
            ->like('nama_instansi', $q)
    ...
    public function prin()
    {
        ...
        $data = array(
            'h'       => $data->row(),
            'content' => 'backend/instansi/instansi_print',
        );
