    ...
    <div class="row">
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('kategori/read/'.$kategori->id_kat),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('kategori/update/'.$kategori->id_kat),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('kategori/delete/'.$kategori->id_kat),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
